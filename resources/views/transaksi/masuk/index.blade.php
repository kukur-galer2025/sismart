    ...
    <div class="sm:hidden space-y-3">
        ...
        <a href="{{ route('barang-masuk.show', $trx->id) }}" class="glass rounded-xl p-4 block">
            ...
            <div class="flex items-center justify-between text-xs">
                ...
                <span class="text-emerald-600 dark:text-emerald-400 font-bold">+{{ number_format($trx->jumlah) }} → Rp {{ number_format($trx->total_harga,0,',','.') }}</span>
            </div>
        </a>
        @empty
        ...
        <div class="table-responsive">
            <table class="w-full text-sm text-left">
                <thead><tr style="background:var(--bg-input)">
                    ...
                    <th class="px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-right" style="color:var(--text-muted)">Total Harga</th>
