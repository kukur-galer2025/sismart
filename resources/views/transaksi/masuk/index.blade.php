...
<div class="space-y-6">
    <div class="space-y-3">
        <form method="GET" action="{{ route('barang-masuk.index') }}" class="flex items-center gap-1.5 flex-wrap">
            ...
            @if(request()->anyFilled(['search','dari','sampai']))<a href="{{ route('barang-masuk.index') }}" class="btn-outline !text-[11px] !py-1.5 !px-2.5"><i class="fas fa-times"></i> Reset</a>@endif
        </form>
